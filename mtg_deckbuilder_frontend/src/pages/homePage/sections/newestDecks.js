...
const NewestDecks = (props) => (
    <Container ref={props.innerRef}>
        <Header>Newest Decks</Header>
        <DeckContainer>
            <DeckPreviewCard deck={{name: "UW Control fsvd svsvvvvvvsefsfsefsefsfevvvdvsvsdvdvs", format:"modern", colors:["w","u"], cards: [{amount:4, name:"Sphinx's Revelation"},{amount:2, name: "Counterspell"}], description:"sdfjonf weof fcefv epwfpoefw powef popefwpoefw oppof powfe po powefpo ewpf opefw "}}/>
