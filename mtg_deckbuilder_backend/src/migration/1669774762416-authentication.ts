...
export class authentication1669774762416 implements MigrationInterface {
    name = 'authentication1669774762416'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "authentication" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accountCreatedDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "rememberMe" boolean NOT NULL, "authenticationString" text NOT NULL, "accountId" uuid NOT NULL, CONSTRAINT "PK_684fcb9924c8502d64b129cc8b1" PRIMARY KEY ("id"))`);
